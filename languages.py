    ...
    def __init__(self):
        ...
        self.languages = [
            Language(
                ...
                "Instruction: If a line start with a yml property (e.g., 'name:', 'question:', 'answer:'), you MUST keep the property name in English.\n"
            ...
            Language(
                ...
                "Anweisung: Wenn eine Zeile mit einer yml-Eigenschaft beginnt (z.B. 'name:', 'question:', 'answer:'), MÜSSEN Sie den Eigenschaftsnamen auf Englisch belassen.\n"
            ...
            Language(
                ...
                "Instrucción: Si una línea comienza con una propiedad yml (por ejemplo, 'name:', 'question:', 'answer:'), DEBES mantener el nombre de la propiedad en inglés.\n"
            ...
            Language(
                ...
                "Istruzione: Se una riga inizia con una proprietà yml (ad es., 'name:', 'question:', 'answer:'), DEVI mantenere il nome della proprietà in inglese.\n"
            ...
            Language(
                ...
                "Instrução: Se uma linha começar com uma propriedade yml (por exemplo, 'name:', 'question:', 'answer:'), você DEVE manter o nome da propriedade em inglês.\n"
            ...
            Language(
                ...
                "Instruction: Si une ligne commence par une propriété yml (par exemple, 'name:', 'question:', 'answer:'), vous DEVEZ garder le nom de la propriété en anglais.\n"
            ...
            Language(
                ...
                "Instruktion: Om en rad börjar med en yml-egenskap (t.ex., 'name:', 'question:', 'answer:'), MÅSTE du behålla egenskapsnamnet på engelska.\n"
            ...
            Language(
                ...
                "تعليمات: إذا بدأت السطر بخاصية yml (مثل، 'name:', 'question:', 'answer:'), يجب عليك الاحتفاظ باسم الخاصية باللغة الإنجليزية.\n"
            ...
            Language(
                ...
                "指示: 行がymlプロパティ（例: 'name:', 'question:', 'answer:'）で始まる場合、プロパティ名は英語のままでなければなりません。\n"
